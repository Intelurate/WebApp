...
const orderInitialState = {
    order: Immutable.fromJS({

        selectedOrder: {
            
            _id: "cg35678vbq4cb3",
            orderId: "54678hv248675",
            purchaseOrderId: "48b5yburbvyelitybr",            
            ...
            items:[{
                ...
                venorPurchaseOrderId: "ieu4wfycir5ybvityb",
                vendorPurchaseOrderDate: "date",
...
function orderReducer(state = orderInitialState.order, action) {
    switch (action.type) {
